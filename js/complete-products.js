...
const productData = [
    ...
    { name: "5-Amino-1MQ API", id: "v5-pep-001", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "SS-31 API", id: "v5-pep-002", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Acetic Acid Water 0.6% API", id: "v5-pep-003", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "AOD9604 API", id: "v5-pep-004", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "ARA-290 API", id: "v5-pep-005", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "AHK-Cu API", id: "v5-pep-006", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Vitamin B12 API", id: "v5-pep-007", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "BAC water          无菌水 WAC API", id: "v5-pep-008", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "BPC157 API", id: "v5-pep-009", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "CJC1295（Without DAC） API", id: "v5-pep-010", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    ...
    { name: "MOTS-C API", id: "v5-pep-022", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Melanotan II API", id: "v5-pep-023", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "NAD+ API", id: "v5-pep-024", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Snap-8 (Argireline) API", id: "v5-pep-025", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "PT-141 API", id: "v5-pep-026", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Retatrutide API", id: "v5-pep-027", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "selank API", id: "v5-pep-028", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Semaglutide API", id: "v5-pep-029", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Sermorelin API", id: "v5-pep-030", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Thymosin Alpha-1 API", id: "v5-pep-031", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "TB500 CTHYMOSIN B4Acetate API", id: "v5-pep-032", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "TB-500 API", id: "v5-pep-033", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Tirzepatide API", id: "v5-pep-034", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Tesamorelin API", id: "v5-pep-035", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Thymalin API", id: "v5-pep-036", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "VIP (Vasoactive Intestinal Peptide) API", id: "v5-pep-037", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Lemon Bottle API", id: "v5-pep-038", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "LC216 Lipolytic API", id: "v5-pep-039", category: "peptide-raw-materials", img: "images/products/default-product.jpg" },
    { name: "Disposable Syringe 3-Part 5ml", id: "v5-sur-001", category: "injection-infusion", img: "images/products/default-product.jpg" },
    { name: "Disposable Syringe 3-Part 10ml", id: "v5-sur-002", category: "injection-infusion", img: "images/products/default-product.jpg" },
    { name: "Pen Needle (GLP-1 Compatible)", id: "v5-sur-003", category: "injection-infusion", img: "images/products/default-product.jpg" },
    { name: "Disposable Biopsy Forceps", id: "v5-sur-004", category: "injection-infusion", img: "images/products/default-product.jpg" },
    { name: "Alcohol Prep Pad", id: "v5-sur-005", category: "injection-infusion", img: "images/products/default-product.jpg" },
    { name: "Vaccine Color Box", id: "v5-pkg-001", category: "pharmaceutical-packaging", img: "images/products/default-product.jpg" },
    { name: "Package Insert / Leaflet", id: "v5-pkg-002", category: "pharmaceutical-packaging", img: "images/products/default-product.jpg" },
    { name: "Vaccination Card + Plastic Sleeve", id: "v5-pkg-003", category: "pharmaceutical-packaging", img: "images/products/default-product.jpg" },
    { name: "Vial Label (Self-Adhesive)", id: "v5-pkg-004", category: "pharmaceutical-packaging", img: "images/products/default-product.jpg" },
    { name: "Pharmaceutical Packaging Kit", id: "v5-pkg-005", category: "pharmaceutical-packaging", img: "images/products/default-product.jpg" },
    { name: "Dental Suture", id: "v5-den-001", category: "dental-products", img: "images/products/default-product.jpg" },
    { name: "Debonding Agent", id: "v5-den-002", category: "dental-products", img: "images/products/default-product.jpg" },
];
